...
public class eStoreSearchTest {
    ...
    @Test public void testSetProductIDBook() throws Exception {
    ...
    @Test public void testSetDescriptionBook() throws Exception {
    ...
    @Test public void testSetYearBook() throws Exception {
    ...
    @Test public void testYourBook() throws Exception {
    ...
    @Test public void testYourElectronic() throws Exception {
    ...
    @Test public void testYourSearch1() throws Exception {
        ...
        store.yourSearch ( theProductID, theKeywords, "", "" );
        assertTrue(productList.contains(myElectronics));
    }

    @Test public void testYourSearch2() throws Exception {
        ...
        store.yourSearch ( theProductID, theTimePeriod, "", "");
        assertTrue(productList.contains(myBooks));
    }

    @Test public void testDuplicateProductIDs() throws Exception {
